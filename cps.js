...
return (function(k,env){
return k(list("\uFDD1quote",data),env); // Line 12 Column 5
}); // Line <unknown undefined> Column <unknown undefined>
});
var cps_dash_set_excl_ = (function(_var_,form){
return (function(k,env){
return cps(form)((function(a,env){
return k(list("\uFDD1set_variable",env,_var_,a),env); // Line 18 Column 8
}),env); // Line 16 Column 5
}); // Line <unknown undefined> Column <unknown undefined>
});
var cps_dash_define = (function(var_slash_func,body){
return (function() {if(list_p_(var_slash_func)) {return (function(k,env){
return cps(list_dash_append(list("\uFDD1lambda",cdr(var_slash_func)),body))((function(a,env){
return k(list("\uFDD1define_variable",env,list("\uFDD1quote",car(var_slash_func)),a),env); // Line 26 Column 12
}),env); // Line 24 Column 9
}); // Line <unknown undefined> Column <unknown undefined>
} else {return (function(k,env){
return cps(car(body))((function(a,env){
return k(list("\uFDD1define_variable",env,list("\uFDD1quote",var_slash_func),a),env); // Line 32 Column 12
}),env); // Line 30 Column 9
}); // Line <unknown undefined> Column <unknown undefined>
}})()
; // Line <unknown undefined> Column <unknown undefined>
});
...
return (function(k,env){
return cps(bool)((function(b,env){
return list("\uFDD1if",b,cps(form1)(k,env),(function() {if(_eq__eq_(form2,false)) {return k(list("\uFDD1quote","\uFDD1void"),env); // Line 43 Column 18
} else {return cps(form2)(k,env); // Line 44 Column 18
}})()
); // Line 40 Column 9
}),env); // Line 38 Column 5
}); // Line <unknown undefined> Column <unknown undefined>
});
var cps_dash_begin = (function(e){
return (function() {if(list_p_(e)) {return (function() {if(list_p_(cdr(e))) {return ((function() {var o1 = (function(voidd){
return (function(k,env){
return cps(car(e))((function(a,env){
return list(list("\uFDD1make-continuation",list("\uFDD1lambda",list(voidd),cps_dash_begin(cdr(e))((function(b,env){
return k(b,env); // Line 50 Column 10
}),env))),a); // Line 50 Column 10
}),env); // Line 50 Column 10
}); // Line <unknown undefined> Column <unknown undefined>
});
var o2 = gensym();
return o1(o2); // Line 50 Column 10
}))(); // Line 50 Column 10
} else {return cps(car(e)); // Line 61 Column 11
}})()
; // Line <unknown undefined> Column <unknown undefined>
} else {return cps(_emptylst); // Line 62 Column 7
}})()
; // Line <unknown undefined> Column <unknown undefined>
});
var cps_dash_application = (function(e){
return (function(k,env){
return (function() {if(list_dash_find(primitives,car(e))) {return cps_dash_terms(cdr(e))((function(t,env){
return k(list_dash_append(list(car(e)),t),env); // Line 69 Column 12
}),env); // Line 67 Column 9
} else {return cps_dash_terms(e)((function(t,env){
return ((function() {var o3 = (function(d){
return list_dash_append(list(car(t),list("\uFDD1make-continuation",list("\uFDD1lambda",list(d),k(d,env)))),cdr(t)); // Line 73 Column 11
});
var o4 = gensym();
return o3(o4); // Line 73 Column 11
}))(); // Line 73 Column 11
}),env); // Line 71 Column 9
}})()
; // Line <unknown undefined> Column <unknown undefined>
}); // Line <unknown undefined> Column <unknown undefined>
});
var cps_dash_terms = (function(e){
return (function() {if(list_p_(e)) {return (function(k,env){
return cps(car(e))((function(a,env){
return cps_dash_terms(cdr(e))((function(as,env){
return k(cons(a,as),env); // Line 86 Column 15
}),env); // Line 84 Column 12
}),env); // Line 82 Column 9
}); // Line <unknown undefined> Column <unknown undefined>
} else {return (function(k,env){
return k(_emptylst,env); // Line 89 Column 23
}); // Line <unknown undefined> Column <unknown undefined>
}})()
; // Line <unknown undefined> Column <unknown undefined>
});
...
return (function(k,env){
return k(((function() {var o5 = (function(c,env2,args){
return list("\uFDD1make-continuation",list("\uFDD1lambda",list_dash_append(list(c),vars),list("\uFDD1extend_environment",env2,env,list("\uFDD1quote",list_dash__gt_vector(vars)),"\uFDD1arguments"),cps(cons("\uFDD1begin",body))((function(a){
return list(c,a); // Line 93 Column 7
}),env2))); // Line 93 Column 7
});
var o6 = gensym();
var o7 = list("\uFDD1quote",gensym());
var o8 = gensym();
return o5(o6,o7,o8); // Line 93 Column 7
}))(),env); // Line 93 Column 5
}); // Line <unknown undefined> Column <unknown undefined>
});
var hoist = (function(exp){
var ks = _emptylst;
var append_dash_ks_excl_ = (function(k){
return ((function() {var o9 = (function(name){
ks = cons(vector(k,name),ks);
return name; // Line <unknown undefined> Column <unknown undefined>
});
var o10 = gensym();
return o9(o10); // Line 120 Column 4
}))(); // Line 120 Column 4
});
var _per_hoist = (function(exp){
return (function() {if((atom_p_(exp) || vector_p_(exp) || dict_p_(exp))) {return exp; // Line <unknown undefined> Column <unknown undefined>
} else {return (function() {if(_eq__eq_(car(exp),"\uFDD1make-continuation")) {return append_dash_ks_excl_(_per_hoist(cadr(exp))); // Line 130 Column 13
} else {return map(_per_hoist,exp); // Line 131 Column 13
}})()
; // Line <unknown undefined> Column <unknown undefined>
}})()
; // Line <unknown undefined> Column <unknown undefined>
});
return ((function() {var o11 = (function(res){
return list_dash_append(list("\uFDD1begin"),map((function(k){
return list("\uFDD1define",vector_dash_ref(k,1),vector_dash_ref(k,0)); // Line 133 Column 2
}),ks),list(res)); // Line 133 Column 2
});
var o12 = _per_hoist(exp);
return o11(o12); // Line 133 Column 2
}))(); // Line 133 Column 2
});
var primitives = list("\uFDD1and","\uFDD1or","\uFDD1+","\uFDD1-","\uFDD1*","\uFDD1/","\uFDD1%","\uFDD1>","\uFDD1<","\uFDD1<=","\uFDD1>=","\uFDD1>>","\uFDD1<<","\uFDD1bitwise-or","\uFDD1bitwise-and","\uFDD1type","\uFDD1number?","\uFDD1string?","\uFDD1symbol?","\uFDD1key?","\uFDD1boolean?","\uFDD1null?","\uFDD1list?","\uFDD1vector?","\uFDD1dict?","\uFDD1function?","\uFDD1literal?","\uFDD1str","\uFDD1symbol->key","\uFDD1key->symbol","\uFDD1string->key","\uFDD1key->string","\uFDD1string->symbol","\uFDD1symbol->string","\uFDD1_emptylst","\uFDD1list","\uFDD1cons","\uFDD1car","\uFDD1cdr","\uFDD1cadr","\uFDD1cddr","\uFDD1cdar","\uFDD1caddr","\uFDD1cdddr","\uFDD1cadar","\uFDD1cddar","\uFDD1caadr","\uFDD1cdadr","\uFDD1list-ref","\uFDD1length","\uFDD1list-append","\uFDD1_list-append","\uFDD1list-find","\uFDD1map","\uFDD1for-each","\uFDD1fold","\uFDD1reverse","\uFDD1vector->list","\uFDD1make-vector","\uFDD1vector","\uFDD1vector-ref","\uFDD1vector-put!","\uFDD1vector-concat","\uFDD1vector-slice","\uFDD1vector-push!","\uFDD1vector-find","\uFDD1vector-length","\uFDD1list->vector","\uFDD1vector-map","\uFDD1vector-for-each","\uFDD1vector-fold","\uFDD1dict","\uFDD1dict-put!","\uFDD1dict-ref","\uFDD1dict-map","\uFDD1dict-merge","\uFDD1dict->vector","\uFDD1dict->list","\uFDD1keys","\uFDD1vals","\uFDD1zip","\uFDD1not","\uFDD1==","\uFDD1=","\uFDD1eq?","\uFDD1equal?","\uFDD1print","\uFDD1println","\uFDD1pp","\uFDD1%inspect-non-sequence","\uFDD1%recur-protect","\uFDD1%space","\uFDD1inspect","\uFDD1apply","\uFDD1trampoline-result?","\uFDD1trampoline","\uFDD1%gensym-base","\uFDD1gensym-fresh","\uFDD1gensym","\uFDD1cps-trampoline","\uFDD1cps-jump","\uFDD1cps-halt","\uFDD1RegExp","\uFDD1s.match","\uFDD1fs.readFileSync","\uFDD1throw","\uFDD1parseInt","\uFDD1parseFloat");
var cps = (function(e){
return (function() {if(symbol_p_(e)) {return ((function() {return (function(k,env){
return (function() {if(list_dash_find(primitives,e)) {return k(e,env); // Line 240 Column 2
} else {return k(list("\uFDD1lookup_variable",env,list("\uFDD1quote",e)),env); // Line 240 Column 2
}})()
; // Line <unknown undefined> Column <unknown undefined>
}); // Line <unknown undefined> Column <unknown undefined>
}))(); // Line 240 Column 2
} else {return (function() {if((atom_p_(e) || dict_p_(e) || vector_p_(e))) {return ((function() {return (function(k,env){
return k(e,env); // Line 240 Column 2
}); // Line <unknown undefined> Column <unknown undefined>
}))(); // Line 240 Column 2
} else {return ((function() {return (function() {if(list_dash_find(list("\uFDD1require"),car(e))) {return ((function() {return (function(k,env){
return list("\uFDD1begin",e,k(list("\uFDD1quote","\uFDD1void"),env)); // Line 240 Column 2
}); // Line <unknown undefined> Column <unknown undefined>
}))(); // Line 240 Column 2
} else {return (function() {if(list_dash_find(list("\uFDD1throw"),car(e))) {return ((function() {return (function(k,env){
return list("\uFDD1begin",e,k(list("\uFDD1quote","\uFDD1void"),env)); // Line 240 Column 2
}); // Line <unknown undefined> Column <unknown undefined>
}))(); // Line 240 Column 2
} else {return (function() {if(list_dash_find(list("\uFDD1quote"),car(e))) {return ((function() {return cps_dash_quote(cadr(e)); // Line 240 Column 2
}))(); // Line 240 Column 2
...
} else {return car(cdddr(e)); // Line 240 Column 2
}})()
); // Line 240 Column 2
}))(); // Line 240 Column 2
} else {return (function() {if(list_dash_find(list("\uFDD1begin"),car(e))) {return ((function() {return cps_dash_begin(cdr(e)); // Line 240 Column 2
}))(); // Line 240 Column 2
} else {return (function() {if(list_dash_find(list("\uFDD1set!"),car(e))) {return ((function() {return cps_dash_set_excl_(cadr(e),caddr(e)); // Line 240 Column 2
}))(); // Line 240 Column 2
} else {return (function() {if(list_dash_find(list("\uFDD1define"),car(e))) {return ((function() {return cps_dash_define(cadr(e),cddr(e)); // Line 240 Column 2
}))(); // Line 240 Column 2
} else {return (function() {if(list_dash_find(list("\uFDD1lambda"),car(e))) {return ((function() {return cps_dash_abstraction(cadr(e),cddr(e)); // Line 240 Column 2
}))(); // Line 240 Column 2
} else {return ((function() {return cps_dash_application(e); // Line 240 Column 2
}))(); // Line 240 Column 2
}})()
; // Line <unknown undefined> Column <unknown undefined>
}})()
...
module["exports"] = dict("\uFDD0cps",(function(src){
return hoist(cps(src)(cps_dash_halt,list("\uFDD1quote","\uFDD1initial"))); // Line 269 Column 30
}));
