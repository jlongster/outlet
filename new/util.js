...
var symbol_dash__gt_term = function(sym){
return unquote_splice_map({"str": sym.str,"term": true})}
;var term_dash__gt_symbol = function(term){
return unquote_splice_map({"str": term.str,"symbol": true})}
;var term_p_ = function(sym){
return sym.term}
;module.exports = unquote_splice_map({"symbol_dash__gt_term": symbol_dash__gt_term,"term_p_": term_p_});
