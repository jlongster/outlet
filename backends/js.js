...
return not((ast["list?"](form) && (_eq__eq_(ast["first*"](form),"\uFDD1throw") || _eq__eq_(ast["first*"](form),"\uFDD1set!") || _eq__eq_(ast["first*"](form),"\uFDD1define"))));
});
...
return ((function() {var o7 = (function(exp,exp){
...
var o8 = ast["node-data"](node);
var o9 = (function() {if(_eq__eq_(o8,"\uFDD1var")) {return ((function() {return "\uFDD1_var_";
}))();
} else {return (function() {if(_eq__eq_(o8,"\uFDD1in")) {return ((function() {return "\uFDD1_in_";
}))();
} else {return ((function() {return o8;
}))();
}})()
;
}})()
...
compile(tru);
write("}");
(function() {if(alt) {return ((function() {write(" else {");
...
return (function() {if(not(null_p_(args))) {return ((function() {var o12 = (function(arg){
...
var o13 = ast["node-data"](car(args));
return o12(o13);
}))();
} else {return false;
}})()
...
write("(function(");
write_dash_args(ast["node-data"](args));
write("){",true);
...
} else {return (function() {if(symbol_p_(ast["node-data"](args))) {return ((function() {write("(function() {",true);
write("var ");
...
} else {return (function() {if(null_p_(ast["node-data"](args))) {return ((function() {return write("(function() {");
}))();
} else {return false;
}})()
;
...
;
((function() {var o14 = (function(i,len){
...
(function() {if((ast["list?"](func) && _eq__eq_(ast["first*"](func),"\uFDD1lambda"))) {return ((function() {write("(");
compile(func,true);
return write(")");
}))();
...
;
write("(");
((function() {var o17 = (function(comma){
return for_dash_each((function(arg){
comma();
return compile(arg,true);
}),args);
});
var o18 = inline_dash_writer(",");
return o17(o18);
}))();
write(")");
return terminate_dash_expr(expr_p_);
...
write("(");
((function() {var o19 = (function(op_dash_writer){
return for_dash_each((function(arg){
op_dash_writer();
return compile(arg,true);
}),vals);
});
var o20 = inline_dash_writer(str(" ",op," "));
return o19(o20);
}))();
write(")");
return terminate_dash_expr(expr_p_);
