...
return o8(o9,o10); // Line 10 Column 0
}))(); // Line 10 Column 0
});
var o4 = fs["readFileSync"](str("tests/",filename),"utf-8");
var o5 = js();
var o6 = (function() {if(_eq_(filename,"syntax.ol")) {return boot; // Line <unknown undefined> Column <unknown undefined>
} else {return compiler; // Line <unknown undefined> Column <unknown undefined>
}})()
;
var o7 = compiler;
return o3(o4,o5,o6,o7); // Line 10 Column 0
}))(); // Line 10 Column 0
});
var o2 = vector_dash_ref(process["argv"],2);
return o1(o2); // Line 10 Column 0
}))(); // Line 10 Column 0
