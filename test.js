...
; // Line <unknown undefined> Column <unknown undefined>
((function() {var o8990379 = (function(filename){
if(arguments.length < 1) {
throw Error("o8990379: not enough arguments")
}
else if(arguments.length > 1) {
throw Error("o8990379: too many arguments");
}
return ((function() {var o8618398 = (function(src,gen,comp,comp){
if(arguments.length < 4) {
throw Error("o8618398: not enough arguments")
}
else if(arguments.length > 4) {
throw Error("o8618398: too many arguments");
}
gen["write-runtime"]("js"); // Line 10 Column 0
comp["set-macro-generator"](gen); // Line 10 Column 0
return ((function() {var o1448562 = (function(s,f){
if(arguments.length < 2) {
throw Error("o1448562: not enough arguments")
}
else if(arguments.length > 2) {
throw Error("o1448562: too many arguments");
}
comp["compile"](f,gen); // Line 10 Column 0
return eval(gen["get-code"]()); // Line 10 Column 0
});
var o1446712 = reader["read"](src);
var o814087 = comp["expand"](o1446712);
return o1448562(o1446712,o814087); // Line 10 Column 0
}))(); // Line 10 Column 0
});
var o4728677 = fs["readFileSync"](str("tests/",filename),"utf-8");
var o1141401 = js();
var o5948845 = (function() {if(_eq_(filename,"syntax.ol")) {return boot; // Line <unknown undefined> Column <unknown undefined>
} else {return compiler; // Line <unknown undefined> Column <unknown undefined>
}})()
;
var o1311872 = compiler;
return o8618398(o4728677,o1141401,o5948845,o1311872); // Line 10 Column 0
}))(); // Line 10 Column 0
});
var o4025899 = vector_dash_ref(process["argv"],2);
return o8990379(o4025899); // Line 10 Column 0
}))(); // Line 10 Column 0
