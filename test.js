...
var fs = require("fs");var compiler = require("./compiler");var boot = require("./boot/compiler");var util = require("util");var js = require("./backends/js");(function() {if((process["argv"]["length"] < 3)) {throw("must pass a filename");
} else {return false;
}})()
;
((function() {var o8895194 = (function(filename){
return ((function() {var o8955037 = (function(src,gen,comp,comp){
comp["set-macro-generator"](gen);
return ((function() {var o8364568 = (function(f){
comp["parse"](f,gen);
return eval(gen["get-code"]());
});
var o7847553 = comp["expand"](comp["read"](src));
return o8364568(o7847553);
}))();
});
var o5600623 = fs["readFileSync"](str("tests/",filename),"utf-8");
var o3518649 = js();
var o8871398 = (function() {if(_eq_(filename,"syntax.ol")) {return boot;
} else {return compiler;
}})()
;
var o8880700 = compiler;
return o8955037(o5600623,o3518649,o8871398,o8880700);
}))();
});
var o6590087 = vector_dash_ref(process["argv"],2);
return o8895194(o6590087);
}))();
