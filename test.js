...
; // Line <unknown undefined> Column <unknown undefined>
((function() {var o345298 = (function(filename){
return ((function() {var o1478156 = (function(src,gen,comp,comp){
gen["write-runtime"]("js"); // Line 10 Column 0
comp["set-macro-generator"](gen); // Line 10 Column 0
return ((function() {var o7380237 = (function(s,f){
comp["compile"](f,gen); // Line 10 Column 0
return eval(gen["get-code"]()); // Line 10 Column 0
});
var o9642339 = reader["read"](src);
var o9168059 = comp["expand"](o9642339);
return o7380237(o9642339,o9168059); // Line 10 Column 0
}))(); // Line 10 Column 0
});
var o9119001 = fs["readFileSync"](str("tests/",filename),"utf-8");
var o7349680 = js();
var o9566272 = (function() {if(_eq_(filename,"syntax.ol")) {return boot; // Line <unknown undefined> Column <unknown undefined>
} else {return compiler; // Line <unknown undefined> Column <unknown undefined>
}})()
;
var o7828200 = compiler;
return o1478156(o9119001,o7349680,o9566272,o7828200); // Line 10 Column 0
}))(); // Line 10 Column 0
});
var o3035115 = vector_dash_ref(process["argv"],2);
return o345298(o3035115); // Line 10 Column 0
}))(); // Line 10 Column 0
