...
return vm["run"](list("\uFDD1begin",list("\uFDD1define",list("\uFDD1rand-int"),list("\uFDD1*",list("\uFDD1rand"),150)),list("\uFDD1define",list("\uFDD1render-rand","\uFDD1x","\uFDD1y","\uFDD1width","\uFDD1height"),list("\uFDD1render-box","green","\uFDD1x","\uFDD1y","\uFDD1width","\uFDD1height")),list("\uFDD1define",list("\uFDD1render-n","\uFDD1n","\uFDD1i"),list("\uFDD1if",list("\uFDD1<","\uFDD1i","\uFDD1n"),list("\uFDD1begin",list("\uFDD1render-rand",list("\uFDD1rand-int"),list("\uFDD1rand-int"),list("\uFDD1rand-int"),list("\uFDD1rand-int")),list("\uFDD1render-n","\uFDD1n",list("\uFDD1+","\uFDD1i",1))))),list("\uFDD1define",list("\uFDD1render"),list("\uFDD1render-clear"),list("\uFDD1render-n",500,0),list("\uFDD1next"),list("\uFDD1render")),list("\uFDD1render")));
}));
