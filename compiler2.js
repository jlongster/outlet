...
var reader = require("./reader");var ast = require("./ast");var js = require("./backends/js");var self_dash_evaluating_p_ = (function(exp){
return (number_p_(exp) || string_p_(exp) || boolean_p_(exp) || null_p_(exp));
});
...
} else {return vector("__tco_call",(function() {return loop(cddr(lst),cons(car(lst),cons(func(cadr(lst)),acc)));
}));
}})()
;
});
...
} else {return (function() {if(ast["dict?"](node)) {return ((function() {return ast["copy-node"](node,alternating_dash_map((function(e){
return expand(e);
}),ast["node-data"](node)));
}))();
} else {return (function() {if(eq_p_(ast["first*"](node),"\uFDD1lambda")) {return ((function() {return ast["copy-node"](node,cons(cadr(node_dash_data(node)),map((function(e){
return expand(e);
}),cddr(node_dash_data(node)))));
}))();
} else {return (function() {if(macro_p_(ast["first*"](node))) {return ((function() {return expand(sourcify(macro_dash_function(ast["first*"](node))(desourcify(node)),ast["node-lineno"](node),ast["node-colno"](node)));
}))();
...
return ((function() {var o3 = (function(quoted_p_){
...
var o4 = opt(quoted_p_,false);
return o3(o4);
}))();
});
var compile_dash_object = (function(node,generator){
var quoted_p_ = vector_dash__gt_list(Array.prototype.slice.call(arguments, 2));
return ((function() {var o5 = (function(exp,quoted_p_){
return (function() {if(symbol_p_(exp)) {return ((function() {return generator["write-symbol"](exp);
}))();
} else {return (function() {if(number_p_(exp)) {return ((function() {return generator["write-number"](exp);
}))();
} else {return (function() {if(boolean_p_(exp)) {return ((function() {return generator["write-boolean"](exp);
}))();
} else {return (function() {if(null_p_(exp)) {return ((function() {return generator["write-empty-list"](exp);
}))();
} else {return (function() {if(ast["list?"](node)) {return ((function() {return compile(apply_dash_node("\uFDD1list",node,quoted_p_),generator);
}))();
} else {return (function() {if(ast["dict?"](node)) {return ((function() {return compile(apply_dash_node("\uFDD1dict",node,quoted_p_),generator);
}))();
} else {return (function() {if(ast["vector?"](node)) {return ((function() {return compile(apply_dash_node("\uFDD1vector",node,quoted_p_),generator);
}))();
...
var o6 = ast["node-data"](node);
var o7 = opt(quoted_p_,false);
return o5(o6,o7);
}))();
});
var compile = (function(node,generator){
var expr_p_ = vector_dash__gt_list(Array.prototype.slice.call(arguments, 2));
var _per_compile = (function(node){
var expr_p_ = vector_dash__gt_list(Array.prototype.slice.call(arguments, 1));
return compile(node,generator,opt(expr_p_,false));
});
return (function() {if(self_dash_evaluating_p_(ast["node-data"](node))) {return ((function() {return compile_dash_object(node,generator);
}))();
} else {return (function() {if(ast["vector?"](node)) {return ((function() {return compile_dash_object(node,generator);
}))();
} else {return (function() {if(ast["dict?"](node)) {return ((function() {return compile_dash_object(node,generator);
}))();
} else {return (function() {if(ast["list?"](node)) {return ((function() {return (function() {if(_eq__eq_(ast["first*"](node),"\uFDD1quote")) {return compile_dash_object(cadr(ast["node-data"](node)),generator,true);
...
;
return generator["write-func-call"](ast["first"](node),cdr(ast["node-data"](node)),true,_per_compile);
}))();
}})()
;
}))();
...
;
return ((function() {var o8 = (function(exp){
...
var o9 = (function() {if(string_p_(src)) {return reader["read"](src);
} else {return src;
}})()
;
return o8(o9);
...
println(compile_dash_program("(foo 2)",js()));
